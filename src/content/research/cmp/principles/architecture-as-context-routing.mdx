...
description: "Architecture is a routing map for context acquisition. This chapter explains how layers, bounded contexts, framework conventions, and system boundaries make decision placement predictable."
book: cmp
part: principles
order: 3
status: published
...
Discoverable means related change surfaces are reachable. The modifier can find the rest of the closure through names, types, tests, registries, schemas, contracts, ownership records, dependency rules, or architecture tests. The relationship among artifacts is recorded in the system, not merely remembered by a senior engineer.
...
For a concrete workflow, see [Post-Change Design Reflection](/blog/post-change-design-reflection/).
