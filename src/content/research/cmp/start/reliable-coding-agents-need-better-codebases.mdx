...
description: "Better models and better harnesses matter. But agents also need codebases where the right context is cheap to find, trust, and use."
book: cmp
part: start
order: 1
status: published
...
canonicalUrl: "https://www.contextcost.dev/research/cmp/start/reliable-coding-agents-need-better-codebases/"
